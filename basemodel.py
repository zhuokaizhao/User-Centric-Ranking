...
class BaseModel(nn.Module):
    ...
    def input_from_feature_columns(self, X, feature_columns, embedding_dict, support_dense=True):
        ...
        # print(feat.embedding_name for feat in sparse_feature_columns)
        # sparse_embedding_list = []
        # print('\n')
        # for i, feat in enumerate(sparse_feature_columns):
        #     print(i, feat.embedding_name, self.feature_index[feat.name])
        #     # print(embedding_dict[feat.embedding_name])
        #     # print(X[:, self.feature_index[feat.name][0]:self.feature_index[feat.name][1]].long())
        #     # print(i, embedding_dict[feat.embedding_name]([0]))
        #     # exit()
